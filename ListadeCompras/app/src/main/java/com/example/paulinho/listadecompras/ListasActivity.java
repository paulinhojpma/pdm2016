...
public class ListasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.base=FirebaseDatabase.getInstance();
        this.ref=base.getReference("Supermercados");
        ...
        // faz um lista de todos os produtos para serem pegos pela lista principal
        ...
        /*for(Produto p: listaCompras.getProdutos()){
            Log.i("BLACKLIST", p.getNome());
        }*/
